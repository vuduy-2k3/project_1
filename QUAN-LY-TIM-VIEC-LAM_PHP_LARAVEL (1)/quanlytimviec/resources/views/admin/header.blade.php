	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class = "dropdown-toggle"><a href="{{route('quanlyuv')}}"><em class="fa fa-plus">&nbsp;</em> Ứng viên</a></li>
			<li class = "dropdown-toggle"><a href="{{route('quanlyntd')}}"><em class="fa fa-plus">&nbsp;</em> Nhà tuyển dụng</a></li>
			<li class = "dropdown-toggle"><a href="{{route('quanlyadmin')}}"><em class="fa fa-plus">&nbsp;</em> Admin</a></li>
