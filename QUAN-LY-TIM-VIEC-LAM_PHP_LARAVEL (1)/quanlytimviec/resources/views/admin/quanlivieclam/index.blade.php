    ...
    <div id="colorgb-pjax-pjax" data-pjax-container="" data-pjax-push-state="" data-pjax-timeout="1000">
        ...
        <div id="colorgb-pjax" class="grid-view hide-resize" data-krajee-grid="kvGridInit_4851d525">
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    <form class="d-flex" method="POST" action="/quanlytimvieclam.com/admin/quan-ly-viec-lam">
                        @csrf
                        <input class="form-control" width="70%" type="search" placeholder="Search" aria-label="Search" name="job">
                        <button class="btn btn-outline-success btn-success" type="submit">Search</button>
                    </form>
                </div>
                <style type="text/css">
                    th {
