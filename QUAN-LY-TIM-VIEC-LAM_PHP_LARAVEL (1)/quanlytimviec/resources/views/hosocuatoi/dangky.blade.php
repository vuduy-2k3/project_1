                                    ...
                                    <div class="col-md-4 col-md-push-8">
                                        <form  action="{{route('dangky')}}" method="post" autocomplete="off" enctype=multipart/form-data> 
                                            ...
                                            <div class="form-group field-registerform-name requiredr">
                                                ...
                                                <input type="text" class="form-control" name="name" placeholder="Hà Phước Sơn">
                                                @error('name')
                                            ...
                                            <div class="form-group field-registerform-email required">
                                                ...
                                                <input type="text" class="form-control" name="email" placeholder="son@gmail.com">
                                                @error('email')
                                                    <div class="alert alert-danger">
                                                        {{$message}}
                                                    </div>                                                    
                                            ...
                                            <div class="form-group field-registerform-password required">
                                                ...
                                                <input type="text" class="form-control" name="diachi" placeholder="Quảng nam">
                                                @error('diachi')
                                                    <div class="alert alert-danger">
                                                        {{$message}}
                                                    </div>                                                    
