...
class QuanlytimvieclamController extends Controller
{
    ...
    public function chitietvieclam($id)
    {
        ...
        return view('vieclam.chitietvieclam',compact('khuvuc','khuvuc_n','nganhnghe_n','nganhnghe','vieclam','ungtuyen','hethang','luu'));
    }
    ...
    public function vieclamcongty($id)
    {
        ...
        return view('vieclam.vieclamcongty',compact('congty','khuvuc','khuvuc_n','nganhnghe_n','nganhnghe','cty','ngayhientai','homqua','toanthoigian','banthoigian','lamtheogio','thuctapsinh','vlcty','count_ngayhientai','count_homqua','count_toanthoigian','count_banthoigian','count_lamtheogio','count_thuctapsinh','count_vlcty'));
    }
    ...
    public function searchvieclam(Request $request)
    {
        $nhatuyendung = Nhatuyendung::where('id_user',Auth::user()->id)->get();
        $cty = Cti::all();
        $cty1 = Cti::all();
        ...
        $khuvuc = Khuvuc::all();
        $chuyenmon = Nganhnghe::all();
        $vieclam = Vieclam::with('Nganhnghe')->whereHas('Nganhnghe', function($query) use($request){
            $query->where('ten_nn', 'LIKE', '%'.$request->input('job').'%');
        })->paginate(10);;
        return view('admin.quanlivieclam.index',compact('nhatuyendung','cty','cty1','khuvuc','khuvuc_n','nganhnghe_n','chuyenmon','vieclam'));
    }
    ...
    public function quanlyUV()
    {
        $user = User::where('level', 1)->paginate(10);
        return view('admin.quanliuser.index',compact('user'));
    }
    public function quanlyNTD()
    {
        $user = User::where('level', 2)->paginate(10);
        return view('admin.quanliuser.index',compact('user'));
    }
    public function quanlyAD()
    {
        $user = User::where('level', 3)->paginate(10);
        return view('admin.quanliuser.index',compact('user'));
    }
