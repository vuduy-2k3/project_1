...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th2 03, 2021 lúc 06:34 AM
...
--
-- Cấu trúc bảng cho bảng `ctis`
--

CREATE TABLE `ctis` (
  `id` int(11) NOT NULL,
  `ten_cty` varchar(100) NOT NULL COMMENT 'tên công ty',
...
--
-- Đang đổ dữ liệu cho bảng `ctis`
--

INSERT INTO `ctis` (`id`, `ten_cty`, `logo`, `banner`, `email`, `sdt`, `diachi`, `id_kv`, `id_nn`, `mota_cty`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE `khuvucs` (
  ...
  `ten_kv` varchar(100) NOT NULL COMMENT 'tên khu vực',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `khuvucs` (`id_kv`, `ten_kv`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE `nganhnghes` (
  ...
  `ten_nn` varchar(100) NOT NULL COMMENT 'tên ngành nghề',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `nganhnghes` (`id_nn`, `ten_nn`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE `nhatuyendungs` (
  ...
  `ten_ndk` varchar(100) NOT NULL COMMENT 'tên người đăng ký',
  `chucvu_ndk` varchar(100) NOT NULL COMMENT 'chức vụ người đăng ký',
  `sdt_ndk` int(11) NOT NULL COMMENT 'số điện thoại người đăng ký',
...
INSERT INTO `nhatuyendungs` (`id`, `id_user`, `id_cty`, `ten_ndk`, `chucvu_ndk`, `sdt_ndk`, `diachi_ndk`, `created_at`, `updated_at`) VALUES
...
(28, 'Hà Phước Sơn', 'kingbossfacebook.com@gmail.com', NULL, '$2y$10$0go3XWldNAV1orW6KCDjNeWZxn6/gC4nwp3LNDDDOp9OgudHX6oWC', 3, NULL, '2020-12-27 23:24:56', '2021-01-05 04:46:45'),
...
(51, 'Hà Phước Sơn', 'uv1@gmail.com', NULL, '$2y$10$sqyNWLZ5bF4Vls98FjBOfumtcOOuqfuPQIE4fM4jlC8qdys5WYLk2', 1, NULL, '2021-01-09 00:20:18', '2021-01-09 00:20:18'),
...
(58, 'Hà Phước Sơn', 'trunghau_246@yahoo.com', NULL, '$2y$10$03v4zPJvcMG7gPhVfTiBlOWbsf2XuHe/OSnAEGs37eZeqww2B3jsq', 1, NULL, '2021-01-24 03:14:03', '2021-01-24 03:14:03'),
...
(63, 'Hà Phước Sơn', 'son@gmail.com', NULL, '$2y$10$RNeijHC8nC/cLdlzgJGz9ek7TtInFgN4x9LQ68BaCqNppgEotvv1C', 1, NULL, '2021-01-28 01:51:51', '2021-01-28 01:51:51'),
(64, 'Hà Phước Sơn', 'son123@gmail.com', NULL, '$2y$10$S7s08aXYS7Afa/Sv22tt8eykA5zFIccdbjd88lsUmvahGqNG2m8pW', 1, NULL, '2021-02-01 21:28:15', '2021-02-01 21:28:15');
...
CREATE TABLE `vieclams` (
  `id` int(11) NOT NULL COMMENT 'id',
  `ten_vl` varchar(100) NOT NULL COMMENT 'tên việc làm',
  ...
  `ngayhethang` date NOT NULL DEFAULT current_timestamp() COMMENT 'ngày hết hạn',
...
INSERT INTO `vieclams` (`id`, `ten_vl`, `id_cty`, `id_nn`, `id_kv`, `ngaydang`, `ngayhethang`, `mucluong`, `tinhchat`, `mota`, `yeucau`, `soluong`, `diachi`, `bangcap`, `kinhnghiem`, `vitri`, `chucvu`, `gioitinh`, `tuoi`, `trangthai`, `created_at`, `updated_at`) VALUES
...
ALTER TABLE `nhatuyendungs`
  ...
  ADD CONSTRAINT `nhatuyendungs_ibfk_3` FOREIGN KEY (`id_cty`) REFERENCES `ctis` (`id`);
...
--
ALTER TABLE `vieclams`
  ADD CONSTRAINT `vieclams_ibfk_1` FOREIGN KEY (`id_cty`) REFERENCES `ctis` (`id`),
